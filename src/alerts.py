...
ALERT_REPORTS = OrderedDict([
    ...
    ("hotsheet", {"label": "Hot Sheet — daily highlights", "group": "Desk & positioning",
                  "email": "hotsheet", "alerts": []}),
    ...
    ("fomc", {"label": "FOMC rate decision", "group": "Central banks",
              "email": None, "alerts": ["FOMC rate decision"]}),
    ("ecb_decision", {"label": "ECB rate decision", "group": "Central banks",
